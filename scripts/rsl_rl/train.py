...
for task_spec in gym.registry.values():
    #previously only added Unitree tasks, updated to include M2 tasks
    if ("M2" in task_spec.id) and "Isaac" not in task_spec.id:
...
import m2_rl.tasks  # noqa: F401
from m2_rl.tasks.locomotion.agents.lidar_actor_critic import register_custom_rsl_rl_modules
from m2_rl.utils.export_deploy_cfg import export_deploy_cfg
