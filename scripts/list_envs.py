...
All the environments are registered in the `m2_rl` extension. They start
with `M2` in their name.
"""
...
def import_packages():
    sys.path.insert(0, f"{pathlib.Path(__file__).parent.parent}/source/m2_rl/m2_rl/tasks/")
