...
from m2_rl.assets.robots.m2 import M2_CFG as ROBOT_CFG
from m2_rl.tasks.locomotion import mdp
...
class TerminationsCfg:
    ...
    base_contact = DoneTerm(
        ...
        params={"sensor_cfg": SceneEntityCfg("contact_forces", body_names=["base_link", ".*_hip" ]), "threshold": 1.0},  # Updated body_name from 'base' to 'base_link' to match the M2_imu.usd file
    )
