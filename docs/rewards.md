...
Custom reward terms are defined in `source/m2_rl/m2_rl/tasks/locomotion/mdp/rewards.py`. This document covers each term's motivation, formula, and tuning rationale.
...
The following terms were added specifically for the M2 platform to address observed failure modes during training.
